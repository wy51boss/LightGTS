...
from src.models.LightGTS_resample import LightGTS
...
parser.add_argument('--context_points', type=int, default=528, help='sequence length')
...
def finetune_func(lr=args.lr):
    ...
    cbs += [
         ...
         SaveModelCB(monitor='valid_mse', fname=args.save_finetuned_model, path=args.save_path),
         EarlyStoppingCB(monitor='valid_mse', patient=args.patience)
        ]
    # define learner
...
def test_func(weight_path):
    ...
    # # ## test setting 
    # args.dset_finetune = 'weather'
    # args.dset = 'weather'
    # args.target_points = 96
    # args.patch_len = 384
    # args.stride = 384
    # args.context_points = 3072
