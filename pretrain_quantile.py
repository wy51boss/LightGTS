...
from src.models.LightGTS_pretrain_quantile import LightGTS
from src.learner_2task_quantitle import Learner, transfer_weights
...
def pretrain_func(lr=args.lr):
    ...
    # get callbacks
    cbs = [RevInCB(1, denorm=True, pretrain=True)] if args.revin else []
    cbs += [
