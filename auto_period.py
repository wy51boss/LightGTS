...
from src.models.LightGTS_pretrain_period import LightGTS
...
parser.add_argument('--dset_finetune', type=str, default='exchange', help='dataset name')
parser.add_argument('--context_points', type=int, default=10, help='sequence length')
parser.add_argument('--target_points', type=int, default=336, help='forecast horizon')
